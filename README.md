...
implement OR/AND logic for tags/products

prevent empty array params in the URL

add default values on hydration
...
idToken jest tokenem Google i może być łatwo podrobiony, jeśli ktoś go przechwyci.

💡 Lepiej zrobić własny podpisany token serwera (np. JWT), który zawiera:
