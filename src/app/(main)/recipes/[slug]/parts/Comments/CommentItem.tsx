...
// export default function CommentItem({ comment, recipeId, refresh, depth = 0 }: { comment: CommentNode; recipeId: string; refresh: () => void; depth?: number }) {
//     const [replyOpen, setReplyOpen] = useState(false);
//     const [replyText, setReplyText] = useState("");
...
//                     <CommentItem key={replyNode._id} comment={replyNode} recipeId={recipeId} refresh={refresh} depth={depth + 1} />
//                 ))}
//             </Box>
//         </Box>
//     );
