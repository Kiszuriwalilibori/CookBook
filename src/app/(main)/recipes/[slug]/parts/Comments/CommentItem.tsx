...
//         const authorToSend = isAdminLogged ? "Piotr" : replyAuthor.trim();

//         if (!authorToSend) return;
...
//                 {replyOpen && (
//                     <Box mt={1} display="flex" flexDirection="column" gap={1}>
//                         {!isAdminLogged && <TextField size="small" fullWidth placeholder="Imię" value={replyAuthor} onChange={e => setReplyAuthor(e.target.value)} />}

//                         <Box display="flex" gap={1}>
//                             <TextField size="small" fullWidth placeholder="Odpowiedź..." value={replyText} onChange={e => setReplyText(e.target.value)} />

//                             <Button onClick={handleReply} disabled={!replyText.trim() || (!isAdminLogged && !replyAuthor.trim())}>
//                                 Wyślij
//                             </Button>
//                         </Box>
//                     </Box>
