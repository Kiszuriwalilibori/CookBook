...
//         const opts = [NO_DIETARY_RESTRICTIONS_LABEL, ...options.dietaryRestrictions];
//         return opts.sort((a, b) => {
//             if (a === NO_DIETARY_RESTRICTIONS_LABEL) return -1;
//             if (b === NO_DIETARY_RESTRICTIONS_LABEL) return 1;
