...
//                             </ListItem>
//                         ) : (
//                             <ListItemButton onClick={item.onClick} sx={mobileMenuItemButtonStyle(currentPathname, item.hidden)}>
//                                 <ListItemIcon sx={mobileMenuIconStyle}>{item.icon}</ListItemIcon>
//                                 <ListItemText
//                                     primary={item.label.trim()}
//                                     slotProps={{
                ...
                {navItems.map(
                    item =>
                        !item.hidden && (
                            <React.Fragment key={item.label}>
                                {item.href ? (
                                    <ListItem component={Link} href={item.href} aria-label={`Navigate to ${item.label}`} onClick={handleDrawerToggle} sx={mobileMenuItemStyle(currentPathname, item.href)}>
                                        <ListItemIcon sx={mobileMenuIconStyle}>{item.icon}</ListItemIcon>
                                        <ListItemText
                                            primary={item.label.trim()}
                                            slotProps={{
                                    ...
                                    <ListItemButton onClick={item.onClick} sx={mobileMenuItemButtonStyle(currentPathname)}>
                                        <ListItemIcon sx={mobileMenuIconStyle}>{item.icon}</ListItemIcon>
                                        <ListItemText
                                            primary={item.label.trim()}
                                            slotProps={{
