                ...
                <Container maxWidth="lg">
                    <Box sx={{ maxWidth: "800px", mx: "auto", textAlign: "center" }}>
                        ...
                        <Typography variant="h6" sx={{ mb: 4, opacity: 0.9 }}>
                            Find the perfect recipe for any occasion. From quick weeknight dinners to impressive feasts, we&rsquo;ve got you covered.
                        </Typography>
                        <Button
                            variant="contained"
                            size="large"
                ...
                <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", sm: "repeat(2, 1fr)", md: "repeat(3, 1fr)", lg: "repeat(4, 1fr)" }, gap: 4 }}>
                    {[
                        ...
                        >
                            ...
                            <Button variant="outlined" size="small" href={`/recipes?category=${category.name.toLowerCase()}`} sx={{ mt: "auto" }}>
                                View Recipes
                            </Button>
                        </Box>
                    ))}
