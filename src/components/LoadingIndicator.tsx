        ...
        >
            ...
            <Paper
                ...
                sx={{
                    ...
                    border: `1px solid ${design.loading.glass.border}`,
                    backdropFilter: "blur(14px)",
                    WebkitBackdropFilter: "blur(14px)",
                    boxShadow: `
                        inset 0 1px 1px ${design.loading.glass.highlight},
                        0 8px 24px ${design.loading.glass.shadow}
                    `,
                }}
            >
                <Typography
                    ...
                    sx={{
                        ...
                        lineHeight: 1.3,
                        letterSpacing: 0.3,
                        textShadow: `0 1px 1px ${design.loading.glass.textShadow}`,
                    }}
                >
                    {prompt}
                </Typography>
            ...
            <svg width="0" height="0" aria-hidden="true" focusable="false">
                <defs>
                    <linearGradient id="mui-spinner-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                        <stop offset="0%" stopColor={design.loading.gradient.cyan} />
                        <stop offset="25%" stopColor={design.loading.gradient.violet} />
                        <stop offset="50%" stopColor={design.loading.gradient.pink} />
                        <stop offset="75%" stopColor={design.loading.gradient.orange} />
                        <stop offset="100%" stopColor={design.loading.gradient.green} />
                    </linearGradient>
                </defs>
            </svg>
        </Box>
